...
pub mod discifi_sentinel {
    ...
    pub fn update_rules(
        ...
        if let Some(v) = daily_limit_usd {
            config.daily_limit_usd = v;
        }
        if let Some(v) = per_tx_limit_usd {
            config.per_tx_limit_usd = v;
        }
        if let Some(v) = velocity_max {
            config.velocity_max = v;
        }
        if let Some(v) = auto_save_bps {
            config.auto_save_bps = v;
        }
        if let Some(v) = slippage_max_bps {
            config.slippage_max_bps = v;
        }
