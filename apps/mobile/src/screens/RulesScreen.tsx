...
const styles = StyleSheet.create({
  ...
  toggleSection: { flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'center', gap: 6 },
  ruleScope: { fontFamily: T.fontFamily, fontSize: 12, color: '#9CA3AF', textAlign: 'right', marginBottom: 4 },
